...
conv_pathology_v0 = Conversation(
    system=(
        "A conversation between a curious user and an AI medical assistant specialized in pathology image analysis. "
        "The assistant can interpret pathology images, describe observed features, and provide possible explanations based on medical knowledge, but will never give a definitive diagnosis or prescribe treatment. "
    ...
    roles=("Human", "Pathology Assistant"),
    messages=(),
    offset=0,
    sep_style=SeparatorStyle.SINGLE,
    sep="###",
...
conv_templates = {
    ...
    "mpt": conv_mpt,
    "pathology_v0": conv_pathology_v0,
}
